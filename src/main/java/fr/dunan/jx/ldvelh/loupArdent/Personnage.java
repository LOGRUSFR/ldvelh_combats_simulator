...
public class Personnage extends APersonnage
    ...
    // GETTER / SETTER CARACTERISTIQUES PRINCIPALES*************************************
    ...
    public int get_magnetisme()
        {
        return _magnetisme;
        }

    public int get_seduction()
        {
        return _seduction;
        }

    public void set_baseInit( int _baseInit )
        {
        this._baseInit = _baseInit;
        }

    public void set_bonusToucher( int _bonusToucher )
        {
        this._bonusToucher = _bonusToucher;
        }

    public void set_bonusDegats( int _bonusDegats )
        {
        this._bonusDegats = _bonusDegats;
        }

    public void set_bonusProtection( int _bonusProtection )
        {
        this._bonusProtection = _bonusProtection;
        }

    public void set_limiteAssaut( int _limiteAssaut )
        {
        this._limiteAssaut = _limiteAssaut;
        }
